...
### 2. 源码说明：
#### 2.1 js文件夹部分
> 2.1.1 一个基于nodejs中间层、express框架及paython后台搭建的ulord开放平台开发的博客系统demo。<br>
> 2.1.2 详细介绍请查看[readme](https://github.com/UlordChain/ulord-blog-demo/blob/master/js/READEME_ZH.MD)
#### 2.2 python文件夹部分
> 2.2.1 一个轻量级的博客，将文章上传至ulord平台并进行定价，其他用户付费查看。所有交易信息均可通过ulord区块浏览器查阅。<br>
> 2.2.1 详细介绍请查看[readme](https://github.com/UlordChain/ulord-blog-demo/blob/master/python/README_ch.mdD)
